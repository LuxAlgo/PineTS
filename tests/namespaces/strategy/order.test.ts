...
plotchar(_position_avg_price, "_position_avg_price")`;
        ...
        // BTCUSDC Mock metadata supplies mincontract = 0.00001. These values
        // were independently recomputed with decimal FIFO accounting, sizing
        // each order as floor((equity * 0.1 / close) / 0.00001) * 0.00001.
        // Example: the first closing order buys 8.97402 of the short opened
        // at 9527.01, closing at 10975.44: P/L = -12998.2397886.
