...
class ScopeManager {
  constructor() {
    __publicField$z(this, "scopes", []);
    __publicField$z(this, "scopeTypes", []);
    __publicField$z(this, "scopeCounts", /* @__PURE__ */ new Map());
    __publicField$z(this, "contextBoundVars", /* @__PURE__ */ new Set());
    __publicField$z(this, "arrayPatternElements", /* @__PURE__ */ new Set());
    __publicField$z(this, "rootParams", /* @__PURE__ */ new Set());
    __publicField$z(this, "localSeriesVars", /* @__PURE__ */ new Set());
    __publicField$z(this, "varKinds", /* @__PURE__ */ new Map());
    __publicField$z(this, "loopVars", /* @__PURE__ */ new Set());
    __publicField$z(this, "loopVarNames", /* @__PURE__ */ new Map());
    // Map original names to transformed names
    __publicField$z(this, "paramIdCounter", 0);
    __publicField$z(this, "cacheIdCounter", 0);
    __publicField$z(this, "tempVarCounter", 0);
    __publicField$z(this, "taCallIdCounter", 0);
    __publicField$z(this, "userCallIdCounter", 0);
    __publicField$z(this, "hoistingStack", []);
    __publicField$z(this, "suppressHoisting", false);
    __publicField$z(this, "reservedNames", /* @__PURE__ */ new Set());
    this.pushScope("glb");
  }
  get nextParamIdArg() {
    return {
...
class Lexer {
  constructor(source) {
    __publicField$y(this, "source");
    __publicField$y(this, "pos");
    __publicField$y(this, "line");
    __publicField$y(this, "column");
    __publicField$y(this, "tokens");
    __publicField$y(this, "indentStack");
    __publicField$y(this, "atLineStart");
    __publicField$y(this, "parenDepth");
    __publicField$y(this, "bracketDepth");
    __publicField$y(this, "braceDepth");
    this.source = source;
    this.pos = 0;
    this.line = 1;
    this.column = 1;
...
class Identifier extends ASTNode {
  constructor(name) {
    super("Identifier");
    this.name = name;
    __publicField$x(this, "varType");
    __publicField$x(this, "returnType");
    __publicField$x(this, "isMethod");
  }
}
...
class CallExpression extends ASTNode {
  constructor(callee, args) {
    ...
    this.callee = callee;
    this.args = args;
    __publicField$x(this, "arguments");
    this.callee = callee;
    this.arguments = args;
  }
}
...
class ConditionalExpression extends ASTNode {
  constructor(test, consequent, alternate) {
    ...
    this.consequent = consequent;
    this.alternate = alternate;
    __publicField$x(this, "needsIIFE");
    __publicField$x(this, "consequentStmts");
    __publicField$x(this, "alternateStmts");
  }
}
...
class Property extends ASTNode {
  constructor(key, value) {
    ...
    this.key = key;
    this.value = value;
    __publicField$x(this, "kind");
    __publicField$x(this, "method");
    __publicField$x(this, "shorthand");
    __publicField$x(this, "computed");
    this.kind = "init";
    this.method = false;
...
class Parser {
  constructor(tokens) {
    __publicField$w(this, "tokens");
    __publicField$w(this, "pos");
    this.tokens = tokens;
    this.pos = 0;
  }
  // Utility methods
...
class CodeGenerator {
  constructor(options = {}) {
    __publicField$v(this, "indent");
    __publicField$v(this, "indentStr");
    __publicField$v(this, "output");
    __publicField$v(this, "sourceCode");
    __publicField$v(this, "sourceLines");
    __publicField$v(this, "lastCommentedLine");
    __publicField$v(this, "includeSourceComments");
    this.indent = 0;
...
var adjustment = /* @__PURE__ */ ((adjustment2) => {
  adjustment2["dividends"] = "dividends";
  adjustment2["none"] = "none";
  adjustment2["splits"] = "splits";
  return adjustment2;
})(adjustment || {});
const alert = {
  freq: {
...
var backadjustment = /* @__PURE__ */ ((backadjustment2) => {
  backadjustment2["inherit"] = "inherit";
  backadjustment2["off"] = "off";
  backadjustment2["on"] = "on";
  return backadjustment2;
})(backadjustment || {});
...
var position$1 = /* @__PURE__ */ ((position2) => {
  position2["bottom_center"] = "bottom_center";
  position2["bottom_left"] = "bottom_left";
  position2["bottom_right"] = "bottom_right";
  position2["middle_center"] = "middle_center";
  position2["middle_left"] = "middle_left";
  position2["middle_right"] = "middle_right";
  position2["top_center"] = "top_center";
...
var settlement_as_close = /* @__PURE__ */ ((settlement_as_close2) => {
  settlement_as_close2["inherit"] = "inherit";
  settlement_as_close2["off"] = "off";
  settlement_as_close2["on"] = "on";
  return settlement_as_close2;
})(settlement_as_close || {});
var splits$1 = /* @__PURE__ */ ((splits2) => {
  splits2["denominator"] = "denominator";
  splits2["numerator"] = "numerator";
  return splits2;
})(splits$1 || {});
const text = {
  // Text alignment
...
var xloc = /* @__PURE__ */ ((xloc2) => {
  xloc2["bar_index"] = "bar_index";
  xloc2["bar_time"] = "bar_time";
  return xloc2;
})(xloc || {});
var yloc = /* @__PURE__ */ ((yloc2) => {
  yloc2["abovebar"] = "abovebar";
  yloc2["belowbar"] = "belowbar";
  yloc2["price"] = "price";
  return yloc2;
})(yloc || {});
const label = {
...
function sort$1(context) {
  return (id, _order = order$1.ascending) => {
    id.array.sort((a, b) => {
      let _a = isNaN(a) ? Infinity : a;
      let _b = isNaN(b) ? Infinity : b;
      return _order === order$1.ascending ? _a - _b : _b - _a;
    });
  };
}
...
function sort_indices(context) {
  return (id, _order = order$1.ascending) => {
    ...
    indices.sort((a, b) => {
      ...
      return _order === order$1.ascending ? valA - valB : valB - valA;
    });
...
class PineArrayObject {
  constructor(array, type, context) {
    ...
    __publicField$u(this, "_abs");
    __publicField$u(this, "_avg");
    __publicField$u(this, "_binary_search");
    __publicField$u(this, "_binary_search_leftmost");
    __publicField$u(this, "_binary_search_rightmost");
    __publicField$u(this, "_clear");
    __publicField$u(this, "_concat");
    __publicField$u(this, "_copy");
    __publicField$u(this, "_covariance");
    __publicField$u(this, "_every");
    __publicField$u(this, "_fill");
    __publicField$u(this, "_first");
    __publicField$u(this, "_get");
    __publicField$u(this, "_includes");
    __publicField$u(this, "_indexof");
    __publicField$u(this, "_insert");
    __publicField$u(this, "_join");
    __publicField$u(this, "_last");
    __publicField$u(this, "_lastindexof");
    __publicField$u(this, "_max");
    __publicField$u(this, "_median");
    __publicField$u(this, "_min");
    __publicField$u(this, "_mode");
    __publicField$u(this, "_percentile_linear_interpolation");
    __publicField$u(this, "_percentile_nearest_rank");
    __publicField$u(this, "_percentrank");
    __publicField$u(this, "_pop");
    __publicField$u(this, "_push");
    __publicField$u(this, "_range");
    __publicField$u(this, "_remove");
    __publicField$u(this, "_reverse");
    __publicField$u(this, "_set");
    __publicField$u(this, "_shift");
    __publicField$u(this, "_size");
    __publicField$u(this, "_slice");
    __publicField$u(this, "_some");
    __publicField$u(this, "_sort");
    __publicField$u(this, "_sort_indices");
    __publicField$u(this, "_standardize");
    __publicField$u(this, "_stdev");
    __publicField$u(this, "_sum");
    __publicField$u(this, "_unshift");
    __publicField$u(this, "_variance");
...
function new_box(context) {
  return (size = 0, initial_value = NaN) => {
    return new PineArrayObject(Array(size).fill(initial_value), PineArrayType.box, context);
  };
}

function new_color(context) {
  return (size = 0, initial_value = "") => {
...
class PineMapObject {
  constructor(context) {
    this.context = context;
    __publicField$t(this, "map");
    __publicField$t(this, "_clear");
    __publicField$t(this, "_contains");
    __publicField$t(this, "_copy");
    __publicField$t(this, "_get");
    __publicField$t(this, "_keys");
    __publicField$t(this, "_put");
    __publicField$t(this, "_put_all");
    __publicField$t(this, "_remove");
    __publicField$t(this, "_size");
    __publicField$t(this, "_values");
...
class PineMatrixObject {
  constructor(rows$1 = 0, cols = 0, initialValue = NaN, context) {
    this.context = context;
    __publicField$s(this, "matrix");
    __publicField$s(this, "_add_col");
    __publicField$s(this, "_add_row");
    __publicField$s(this, "_avg");
    __publicField$s(this, "_col");
    __publicField$s(this, "_columns");
    __publicField$s(this, "_concat");
    __publicField$s(this, "_copy");
    __publicField$s(this, "_det");
    __publicField$s(this, "_diff");
    __publicField$s(this, "_eigenvalues");
    __publicField$s(this, "_eigenvectors");
    __publicField$s(this, "_elements_count");
    __publicField$s(this, "_fill");
    __publicField$s(this, "_get");
    __publicField$s(this, "_inv");
    __publicField$s(this, "_is_antidiagonal");
    __publicField$s(this, "_is_antisymmetric");
    __publicField$s(this, "_is_binary");
    __publicField$s(this, "_is_diagonal");
    __publicField$s(this, "_is_identity");
    __publicField$s(this, "_is_square");
    __publicField$s(this, "_is_stochastic");
    __publicField$s(this, "_is_symmetric");
    __publicField$s(this, "_is_triangular");
    __publicField$s(this, "_is_zero");
    __publicField$s(this, "_kron");
    __publicField$s(this, "_max");
    __publicField$s(this, "_median");
    __publicField$s(this, "_min");
    __publicField$s(this, "_mode");
    __publicField$s(this, "_mult");
    __publicField$s(this, "_pinv");
    __publicField$s(this, "_pow");
    __publicField$s(this, "_rank");
    __publicField$s(this, "_remove_col");
    __publicField$s(this, "_remove_row");
    __publicField$s(this, "_reshape");
    __publicField$s(this, "_reverse");
    __publicField$s(this, "_row");
    __publicField$s(this, "_rows");
    __publicField$s(this, "_set");
    __publicField$s(this, "_sort");
    __publicField$s(this, "_submatrix");
    __publicField$s(this, "_sum");
    __publicField$s(this, "_swap_columns");
    __publicField$s(this, "_swap_rows");
    __publicField$s(this, "_trace");
    __publicField$s(this, "_transpose");
    this.matrix = [];
    if (rows$1 > 0 && cols > 0) {
...
function avg_losing_trade(context) {
  return () => {
...
function avg_winning_trade(context) {
  return () => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
function close(context) {
  return (id, comment, alert_message, immediately, disable_alert) => {
    const engine = context._strategyEngine;
    if (!engine) {
      console.warn("Strategy not initialized. Call strategy() first.");
      return;
    ...
    const matchingTrades = state.open_trades.filter((t) => t.entry_id === id);
    if (matchingTrades.length === 0) {
      return;
    }
    const qtyToClose = matchingTrades.reduce((sum, t) => sum + t.size, 0);
    const exitDirection = state.position_size > 0 ? "short" : "long";
    if (immediately) {
      const currentPrice = context.data.close instanceof Series ? context.data.close.get(0) : context.data.close;
      const time = context.data.openTime instanceof Series ? context.data.openTime.get(0) : Date.now();
      ...
      engine.addOrder({
        ...
        alert_message,
        isExit: true
        // Mark as exit order to prevent opening new position
      });
    }
  };
}

function close_all(context) {
  return (comment, alert_message, immediately, disable_alert) => {
    const engine = context._strategyEngine;
    if (!engine) {
      console.warn("Strategy not initialized. Call strategy() first.");
      return;
...
function closedtrades_commission(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
function closedtrades_entry_bar_index(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return NaN;
...
function closedtrades_entry_price(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return NaN;
...
function closedtrades_exit_bar_index(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return NaN;
...
function closedtrades_exit_price(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return NaN;
...
function closedtrades_max_drawdown(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
function closedtrades_max_runup(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
function closedtrades_profit(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
function closedtrades_size(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
function entry(context) {
  return (id, direction, qty, limit, stop, oca_name, oca_type, comment, alert_message, disable_alert) => {
    const engine = context._strategyEngine;
    if (!engine) {
      console.warn("Strategy not initialized. Call strategy() first.");
      return;
    }
    const getVal = (v) => v instanceof Series ? v.get(0) : v;
    const orderQty = qty !== void 0 ? getVal(qty) : engine.getDefaultQty();
    const limitPrice = limit !== void 0 ? getVal(limit) : void 0;
    const stopPrice = stop !== void 0 ? getVal(stop) : void 0;
    engine.addOrder({
...
function exit(context) {
  return (id, from_entry, qty, qty_percent, profit, limit, loss, stop, trail_price, trail_points, trail_offset, oca_name, comment, comment_profit, comment_loss, comment_trailing, alert_message, alert_profit, alert_loss, alert_trailing, disable_alert) => {
    const engine = context._strategyEngine;
    if (!engine) {
      console.warn("Strategy not initialized. Call strategy() first.");
      return;
    ...
    let limitPrice = limit !== void 0 ? getVal(limit) : void 0;
    let stopPrice = stop !== void 0 ? getVal(stop) : void 0;
    if (profit !== void 0 && limitPrice === void 0) {
    ...
    if (loss !== void 0 && stopPrice === void 0) {
    ...
    if (trail_points !== void 0 || trail_price !== void 0) {
      const currentPrice = context.data.close instanceof Series ? context.data.close.get(0) : context.data.close;
      let trailStop;
      if (trail_points !== void 0) {
    ...
    if (limitPrice === void 0 && stopPrice === void 0 && trail_points === void 0 && trail_price === void 0) {
      engine.addOrder({
        id,
        direction: exitDirection,
        qty: exitQty,
...
function initial_capital(context) {
  return () => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 1e5;
...
function opentrades_entry_bar_index(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return NaN;
...
function opentrades_entry_id(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return "";
...
function opentrades_entry_price(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return NaN;
...
function opentrades_entry_time(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return NaN;
...
function opentrades_profit(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
function opentrades_size(context) {
  return (trade_num) => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
function position_avg_price(context) {
  return () => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
function position_size(context) {
  return () => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
function profit_factor(context) {
  return () => {
    const engine = context._strategyEngine;
    if (!engine) {
      return 0;
...
const cash = "cash";
const fixed = "fixed";
const percent_of_equity = "percent_of_equity";
...
class StrategyEngine {
  constructor(context) {
    ...
    __publicField$r(this, "_tradeIdCounter", 0);
    __publicField$r(this, "_orderIdCounter", 0);
    this.context = context;
  ...
  initialize(options) {
    ...
    this.state.initial_capital = this.state.options.initial_capital || 1e5;
   ...
   */
  checkOrderFill(order, open, high, low, close) {
   ...
   */
  executeOrder(order, fillPrice, barIndex, time) {
   ...
   */
  openLongPosition(order, fillPrice, barIndex, time, commission) {
   ...
   */
  openShortPosition(order, fillPrice, barIndex, time, commission) {
    const currentSize = this.state.position_size;
    if (currentSize > 0) {
   ...
   * Close a position
   */
  closePosition(exitPrice, barIndex, time, qty, exitId) {
   ...
   * Close all positions
   */
  closeAllPositions(exitId = "close_all") {
  ...
  updateEquity() {
    ...
    for (const trade of this.state.open_trades) {
      ...
      const tradeProfit = trade.direction === "long" ? (currentPrice - trade.entry_price) * trade.size : (trade.entry_price - currentPrice) * trade.size;
...
function strategy(context) {
  return (title, shorttitle, overlay, format, precision, scale, pyramiding, calc_on_order_fills, calc_on_every_tick, max_bars_back, backtest_fill_limits_assumption, default_qty_type, default_qty_value, initial_capital, currency, slippage, commission_type, commission_value, process_orders_on_close, close_entries_rule, margin_long, margin_short, explicit_plot_zorder, max_lines_count, max_labels_count, max_boxes_count, risk_free_rate, use_bar_magnifier, fill_orders_on_standard_ohlc, max_polylines_count) => {
    ...
    const options = {
      ...
      initial_capital: initial_capital ?? 1e5,
...
class PineStrategy {
  constructor(context) {
    ...
    __publicField$q(this, "_propertyCache", {});
    // Constants
    __publicField$q(this, "direction", direction);
    __publicField$q(this, "oca", oca_type);
    __publicField$q(this, "commission", commission_type);
    __publicField$q(this, "position", position);
    __publicField$q(this, "cash", cash);
    __publicField$q(this, "fixed", fixed);
    __publicField$q(this, "percent_of_equity", percent_of_equity);
    __publicField$q(this, "long", "long");
    __publicField$q(this, "short", "short");
    // Sub-namespaces (callable with methods attached)
    __publicField$q(this, "opentrades");
    __publicField$q(this, "closedtrades");
    // Action methods
    __publicField$q(this, "cancel");
    __publicField$q(this, "cancel_all");
    __publicField$q(this, "close");
    __publicField$q(this, "close_all");
    __publicField$q(this, "entry");
    __publicField$q(this, "exit");
    __publicField$q(this, "order");
    __publicField$q(this, "param");
    __publicField$q(this, "strategy");
    // Properties (using Object.defineProperty for getters)
    __publicField$q(this, "position_size");
    __publicField$q(this, "position_avg_price");
    __publicField$q(this, "equity");
    __publicField$q(this, "initial_capital");
    __publicField$q(this, "openprofit");
    __publicField$q(this, "netprofit");
    __publicField$q(this, "grossprofit");
    __publicField$q(this, "grossloss");
    __publicField$q(this, "wintrades");
    __publicField$q(this, "losstrades");
    __publicField$q(this, "eventrades");
    __publicField$q(this, "max_drawdown");
    __publicField$q(this, "max_runup");
    __publicField$q(this, "profit_factor");
    __publicField$q(this, "avg_trade");
    __publicField$q(this, "avg_winning_trade");
    __publicField$q(this, "avg_losing_trade");
    __publicField$q(this, "win_rate");
    __publicField$q(this, "sharpe_ratio");
    this.context = context;
    if (!context._strategyEngine) {
      context._strategyEngine = new StrategyEngine(context);
    }
...
class Barstate {
  constructor(context) {
    this.context = context;
    __publicField$p(this, "_live", false);
  }
  setLive() {
    this._live = true;
  }
...
class Core {
   ...
   */
  _parseColorComponent(color, component) {
   ...
   */
  dayofmonth(time) {
    const t = time !== void 0 ? Series.from(time).get(0) : this.context.pine.time;
    if (t === null || t === void 0 || Number.isNaN(t)) return NaN;
  ...
  timestamp(year, month, day, hour = 0, minute = 0, second = 0) {
    ...
    if ([y, mo, d].some((v) => v === null || v === void 0 || Number.isNaN(v))) {
      return NaN;
    }
...
class Input {
  constructor(context) {
    this.context = context;
    __publicField$n(this, "any");
    __publicField$n(this, "bool");
    __publicField$n(this, "color");
    __publicField$n(this, "enum");
    __publicField$n(this, "float");
    __publicField$n(this, "int");
    __publicField$n(this, "param");
    __publicField$n(this, "price");
    __publicField$n(this, "session");
    __publicField$n(this, "source");
    __publicField$n(this, "string");
    __publicField$n(this, "symbol");
    __publicField$n(this, "text_area");
    __publicField$n(this, "time");
    __publicField$n(this, "timeframe");
...
class PineMath {
  constructor(context) {
    this.context = context;
    __publicField$m(this, "_cache", {});
    __publicField$m(this, "__eq");
    __publicField$m(this, "abs");
    __publicField$m(this, "acos");
    __publicField$m(this, "asin");
    __publicField$m(this, "atan");
    __publicField$m(this, "avg");
    __publicField$m(this, "ceil");
    __publicField$m(this, "cos");
    __publicField$m(this, "e");
    __publicField$m(this, "exp");
    __publicField$m(this, "floor");
    __publicField$m(this, "ln");
    __publicField$m(this, "log");
    __publicField$m(this, "log10");
    __publicField$m(this, "max");
    __publicField$m(this, "min");
    __publicField$m(this, "param");
    __publicField$m(this, "phi");
    __publicField$m(this, "pi");
    __publicField$m(this, "pow");
    __publicField$m(this, "random");
    __publicField$m(this, "round");
    __publicField$m(this, "round_to_mintick");
    __publicField$m(this, "rphi");
    __publicField$m(this, "sign");
    __publicField$m(this, "sin");
    __publicField$m(this, "sqrt");
    __publicField$m(this, "sum");
    __publicField$m(this, "tan");
    __publicField$m(this, "todegrees");
    __publicField$m(this, "toradians");
...
function unwrapParam$1(param) {
  if (Array.isArray(param) && param.length === 2 && typeof param[1] === "string") {
    return param[0];
  }
  return param;
}
function currency_rate(context) {
  return (from, to, ignore_invalid_currency = false) => {
    const rawFrom = unwrapParam$1(from);
    const rawTo = unwrapParam$1(to);
    ...
    if (rates[fromUsdKey] !== void 0 && rates[usdToKey] !== void 0) {
...
function dividends(context) {
  return (ticker = null, field = "gross", gaps = true, lookahead = false, ignore_invalid_symbol = false, currency = null) => {
    return NaN;
  };
}

function earnings(context) {
  return (ticker = null, field = "actual", gaps = true, lookahead = false, ignore_invalid_symbol = false, currency = null) => {
...
function economic(context) {
  return (country_code, field, gaps = true, ignore_invalid_symbol = false) => {
    return NaN;
  };
}

function financial(context) {
  return (symbol, financial_id, period = "FQ", gaps = true, ignore_invalid_symbol = false, currency = null) => {
    return NaN;
  };
}
...
function quandl(context) {
  return (ticker, gaps = true, index = 0, ignore_invalid_symbol = false) => {
...
function splits(context) {
  return (ticker = null, field = "numerator", gaps = true, lookahead = false, ignore_invalid_symbol = false) => {
...
class PineRequest {
  constructor(context) {
    this.context = context;
    __publicField$l(this, "_cache", {});
    __publicField$l(this, "currency_rate");
    __publicField$l(this, "dividends");
    __publicField$l(this, "earnings");
    __publicField$l(this, "economic");
    __publicField$l(this, "financial");
    __publicField$l(this, "param");
    __publicField$l(this, "quandl");
    __publicField$l(this, "security");
    __publicField$l(this, "security_lower_tf");
    __publicField$l(this, "seed");
    __publicField$l(this, "splits");
...
class TechnicalAnalysis {
  constructor(context) {
    this.context = context;
    __publicField$k(this, "accdist");
    __publicField$k(this, "alma");
    __publicField$k(this, "atr");
    __publicField$k(this, "barssince");
    __publicField$k(this, "bb");
    __publicField$k(this, "bbw");
    __publicField$k(this, "cci");
    __publicField$k(this, "change");
    __publicField$k(this, "cmo");
    __publicField$k(this, "cog");
    __publicField$k(this, "correlation");
    __publicField$k(this, "cross");
    __publicField$k(this, "crossover");
    __publicField$k(this, "crossunder");
    __publicField$k(this, "cum");
    __publicField$k(this, "dev");
    __publicField$k(this, "dmi");
    __publicField$k(this, "ema");
    __publicField$k(this, "falling");
    __publicField$k(this, "highest");
    __publicField$k(this, "highestbars");
    __publicField$k(this, "hma");
    __publicField$k(this, "iii");
    __publicField$k(this, "kc");
    __publicField$k(this, "kcw");
    __publicField$k(this, "linreg");
    __publicField$k(this, "lowest");
    __publicField$k(this, "lowestbars");
    __publicField$k(this, "macd");
    __publicField$k(this, "median");
    __publicField$k(this, "mfi");
    __publicField$k(this, "mode");
    __publicField$k(this, "mom");
    __publicField$k(this, "nvi");
    __publicField$k(this, "obv");
    __publicField$k(this, "param");
    __publicField$k(this, "percentile_linear_interpolation");
    __publicField$k(this, "percentile_nearest_rank");
    __publicField$k(this, "percentrank");
    __publicField$k(this, "pivothigh");
    __publicField$k(this, "pivotlow");
    __publicField$k(this, "pvi");
    __publicField$k(this, "pvt");
    __publicField$k(this, "range");
    __publicField$k(this, "rising");
    __publicField$k(this, "rma");
    __publicField$k(this, "roc");
    __publicField$k(this, "rsi");
    __publicField$k(this, "sar");
    __publicField$k(this, "sma");
    __publicField$k(this, "stdev");
    __publicField$k(this, "stoch");
    __publicField$k(this, "supertrend");
    __publicField$k(this, "swma");
    __publicField$k(this, "tr");
    __publicField$k(this, "tsi");
    __publicField$k(this, "valuewhen");
    __publicField$k(this, "variance");
    __publicField$k(this, "vwap");
    __publicField$k(this, "vwma");
    __publicField$k(this, "wad");
    __publicField$k(this, "wma");
    __publicField$k(this, "wpr");
    __publicField$k(this, "wvad");
...
class Str {
   ...
   */
  format_time(time, format = "yyyy.MM.dd HH:mm:ss", timezone) {
    if (time === null || time === void 0 || Number.isNaN(time)) {
      return "";
    }
...
class Ticker {
   ...
   */
  new(prefix, ticker, session, adjustment) {
   ...
   */
  modify(tickerid, session, adjustment) {
    return tickerid;
  }
  /**
   ...
   */
  renko(symbol, boxsize = 1, style = "Traditional", request_wicks = false, session, adjustment) {
    const baseSymbol = symbol || this._getCurrentTickerId();
   ...
   */
  linebreak(symbol, number_of_lines = 3, session, adjustment) {
    const baseSymbol = symbol || this._getCurrentTickerId();
   ...
   */
  kagi(symbol, reversal = 1, session, adjustment) {
    const baseSymbol = symbol || this._getCurrentTickerId();
   ...
   */
  pointfigure(symbol, source = "hl", boxsize = 1, reversal = 3, session, adjustment) {
    const baseSymbol = symbol || this._getCurrentTickerId();
...
function createCallableProperty(defaultValue, parser) {
  const fn = ((tickerid) => {
    if (tickerid !== void 0) {
...
class Syminfo {
  constructor(context) {
    this.context = context;
    __publicField$j(this, "_info", null);
  }
  /**
  ...
  get prefix() {
    ...
    return createCallableProperty(value, (tickerid) => {
...
class Chart {
  constructor(context) {
    ...
    __publicField$i(this, "point", {
      ...
      now: (price) => {
        const context = this.context;
        const priceVal = price !== void 0 ? Series.from(price).get(0) : context.data?.close?.get(0) || NaN;
        return {
          index: context.idx || 0,
...
class Session {
  ...
  get isfirstbar() {
    ...
    if (isNaN(prevTime)) return true;
    const currentDate = new Date(currentTime);
    const prevDate = new Date(prevTime);
    return currentDate.getUTCFullYear() !== prevDate.getUTCFullYear() || currentDate.getUTCMonth() !== prevDate.getUTCMonth() || currentDate.getUTCDate() !== prevDate.getUTCDate();
  }
  /**
  ...
  get islastbar() {
    ...
    if (nextIdx < context.data?.openTime?.length) {
      ...
      if (nextActualIdx < dataLength) {
        ...
        return currentDate.getUTCFullYear() !== nextDate.getUTCFullYear() || currentDate.getUTCMonth() !== nextDate.getUTCMonth() || currentDate.getUTCDate() !== nextDate.getUTCDate();
      }
    }
    return false;
  }
  ...
  get ispostmarket() {
    ...
    const utcMinute = date.getUTCMinutes();
    const utcTime = utcHour * 60 + utcMinute;
    const postMarketStart = 21 * 60;
    const postMarketEnd = 24 * 60;
...
const _BoxObject = class _BoxObject {
  constructor(context, options = {}) {
    this.context = context;
    __publicField$g(this, "_id");
    __publicField$g(this, "_left");
    __publicField$g(this, "_top");
    __publicField$g(this, "_right");
    __publicField$g(this, "_bottom");
    __publicField$g(this, "_border_color");
    __publicField$g(this, "_border_width");
    __publicField$g(this, "_border_style");
    __publicField$g(this, "_bgcolor");
    __publicField$g(this, "_extend");
    __publicField$g(this, "_xloc");
    __publicField$g(this, "_text");
    __publicField$g(this, "_text_size");
    __publicField$g(this, "_text_color");
    __publicField$g(this, "_text_halign");
    __publicField$g(this, "_text_valign");
    __publicField$g(this, "_text_wrap");
    __publicField$g(this, "_text_font_family");
    this._id = _BoxObject._nextId++;
  ...
  set_lefttop(left, top) {
    this._left = Series.from(left).get(0);
    this._top = Series.from(top).get(0);
  }
  set_rightbottom(right, bottom) {
    this._right = Series.from(right).get(0);
    this._bottom = Series.from(bottom).get(0);
  }
   ...
   */
  copy() {
    return new _BoxObject(this.context, {
      left: this._left,
      top: this._top,
      right: this._right,
      bottom: this._bottom,
...
__publicField$g(_BoxObject, "_nextId", 1);
let BoxObject = _BoxObject;
...
class Box {
   ...
   */
  new(left, top, right, bottom, border_color, border_width, border_style, extend, xloc, bgcolor, text, text_size, text_color, text_halign, text_valign, text_wrap, text_font_family) {
    const box = new BoxObject(this.context, {
      ...
      border_color: border_color ? Series.from(border_color).get(0) : void 0,
      border_width: border_width ? Series.from(border_width).get(0) : void 0,
      border_style: border_style ? Series.from(border_style).get(0) : void 0,
      bgcolor: bgcolor ? Series.from(bgcolor).get(0) : void 0,
      extend: extend ? Series.from(extend).get(0) : void 0,
      xloc: xloc ? Series.from(xloc).get(0) : void 0,
      text: text ? Series.from(text).get(0) : void 0,
      text_size: text_size ? Series.from(text_size).get(0) : void 0,
      text_color: text_color ? Series.from(text_color).get(0) : void 0,
      text_halign: text_halign ? Series.from(text_halign).get(0) : void 0,
      text_valign: text_valign ? Series.from(text_valign).get(0) : void 0,
      text_wrap: text_wrap ? Series.from(text_wrap).get(0) : void 0,
      text_font_family: text_font_family ? Series.from(text_font_family).get(0) : void 0
    });
  ...
  set_bottom(id, bottom) {
    id?.set_bottom(bottom);
  }
  set_lefttop(id, left, top) {
    id?.set_lefttop(left, top);
  }
  set_rightbottom(id, right, bottom) {
    id?.set_rightbottom(right, bottom);
  }
  set_border_color(id, color) {
    id?.set_border_color(color);
  }
  set_border_width(id, width) {
    id?.set_border_width(width);
  }
  set_border_style(id, style) {
    id?.set_border_style(style);
  }
  set_bgcolor(id, color) {
  ...
  set_text_color(id, color) {
    id?.set_text_color(color);
  }
  set_text_halign(id, halign) {
    id?.set_text_halign(halign);
  }
  set_text_valign(id, valign) {
    id?.set_text_valign(valign);
  }
  set_text_wrap(id, wrap) {
    id?.set_text_wrap(wrap);
  }
  set_text_font_family(id, family) {
...
const _LabelObject = class _LabelObject {
  constructor(context, options = {}) {
    this.context = context;
    __publicField$e(this, "_id");
    __publicField$e(this, "_x");
    __publicField$e(this, "_y");
    __publicField$e(this, "_text");
    __publicField$e(this, "_xloc");
    __publicField$e(this, "_yloc");
    __publicField$e(this, "_color");
    __publicField$e(this, "_style");
    __publicField$e(this, "_textcolor");
    __publicField$e(this, "_size");
    __publicField$e(this, "_textalign");
    __publicField$e(this, "_tooltip");
    __publicField$e(this, "_text_font_family");
    this._id = _LabelObject._nextId++;
    this._x = options.x ?? 0;
    this._y = options.y ?? 0;
    this._text = options.text ?? "";
    this._xloc = options.xloc ?? "bar_index";
   ...
   */
  copy() {
    return new _LabelObject(this.context, {
      x: this._x,
      y: this._y,
      text: this._text,
      xloc: this._xloc,
...
__publicField$e(_LabelObject, "_nextId", 1);
let LabelObject = _LabelObject;
...
class Label {
   ...
   */
  new(x, y, text, xloc, yloc, color, style, textcolor, size, textalign, tooltip, text_font_family) {
    const label = new LabelObject(this.context, {
      x: Series.from(x).get(0),
      y: Series.from(y).get(0),
      text: Series.from(text).get(0),
      xloc: xloc ? Series.from(xloc).get(0) : void 0,
      yloc: yloc ? Series.from(yloc).get(0) : void 0,
      color: color ? Series.from(color).get(0) : void 0,
      style: style ? Series.from(style).get(0) : void 0,
      textcolor: textcolor ? Series.from(textcolor).get(0) : void 0,
      size: size ? Series.from(size).get(0) : void 0,
      textalign: textalign ? Series.from(textalign).get(0) : void 0,
      tooltip: tooltip ? Series.from(tooltip).get(0) : void 0,
      text_font_family: text_font_family ? Series.from(text_font_family).get(0) : void 0
    });
  ...
  set_textcolor(id, color) {
    id?.set_textcolor(color);
  }
  set_size(id, size) {
    id?.set_size(size);
  }
  set_textalign(id, align) {
...
// Label styles
__publicField$d(Label, "style_arrowdown", "arrowdown");
__publicField$d(Label, "style_arrowup", "arrowup");
__publicField$d(Label, "style_circle", "circle");
__publicField$d(Label, "style_cross", "cross");
__publicField$d(Label, "style_diamond", "diamond");
__publicField$d(Label, "style_flag", "flag");
__publicField$d(Label, "style_label_center", "label_center");
__publicField$d(Label, "style_label_down", "label_down");
__publicField$d(Label, "style_label_left", "label_left");
__publicField$d(Label, "style_label_lower_left", "label_lower_left");
__publicField$d(Label, "style_label_lower_right", "label_lower_right");
__publicField$d(Label, "style_label_right", "label_right");
__publicField$d(Label, "style_label_up", "label_up");
__publicField$d(Label, "style_label_upper_left", "label_upper_left");
__publicField$d(Label, "style_label_upper_right", "label_upper_right");
__publicField$d(Label, "style_none", "none");
__publicField$d(Label, "style_square", "square");
__publicField$d(Label, "style_text_outline", "text_outline");
__publicField$d(Label, "style_triangledown", "triangledown");
__publicField$d(Label, "style_triangleup", "triangleup");
__publicField$d(Label, "style_xcross", "xcross");

var __defProp$c = Object.defineProperty;
var __defNormalProp$c = (obj, key, value) => key in obj ? __defProp$c(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField$c = (obj, key, value) => __defNormalProp$c(obj, typeof key !== "symbol" ? key + "" : key, value);
const _LineObject = class _LineObject {
  constructor(context, options = {}) {
    this.context = context;
    __publicField$c(this, "_id");
    __publicField$c(this, "_x1");
    __publicField$c(this, "_y1");
    __publicField$c(this, "_x2");
    __publicField$c(this, "_y2");
    __publicField$c(this, "_xloc");
    __publicField$c(this, "_extend");
    __publicField$c(this, "_color");
    __publicField$c(this, "_style");
    __publicField$c(this, "_width");
    this._id = _LineObject._nextId++;
   ...
   */
  copy() {
    return new _LineObject(this.context, {
      x1: this._x1,
      y1: this._y1,
      x2: this._x2,
      y2: this._y2,
...
__publicField$c(_LineObject, "_nextId", 1);
let LineObject = _LineObject;
...
class Line {
   ...
   */
  new(x1, y1, x2, y2, xloc, extend, color, style, width) {
    const line = new LineObject(this.context, {
      ...
      color: color ? Series.from(color).get(0) : void 0,
      style: style ? Series.from(style).get(0) : void 0,
      width: width ? Series.from(width).get(0) : void 0
    });
  ...
  set_first_point(id, point) {
    id?.set_first_point(point);
  }
  set_second_point(id, point) {
...
// Line styles
__publicField$b(Line, "style_arrow_both", "arrow_both");
__publicField$b(Line, "style_arrow_left", "arrow_left");
__publicField$b(Line, "style_arrow_right", "arrow_right");
__publicField$b(Line, "style_dashed", "dashed");
__publicField$b(Line, "style_dotted", "dotted");
__publicField$b(Line, "style_solid", "solid");

var __defProp$a = Object.defineProperty;
var __defNormalProp$a = (obj, key, value) => key in obj ? __defProp$a(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField$a = (obj, key, value) => __defNormalProp$a(obj, typeof key !== "symbol" ? key + "" : key, value);
const _LinefillObject = class _LinefillObject {
  constructor(context, options) {
    this.context = context;
    __publicField$a(this, "_id");
    __publicField$a(this, "_line1");
    __publicField$a(this, "_line2");
    __publicField$a(this, "_color");
    this._id = _LinefillObject._nextId++;
...
__publicField$a(_LinefillObject, "_nextId", 1);
let LinefillObject = _LinefillObject;
...
class Linefill {
  constructor(context) {
    this.context = context;
    __publicField$9(this, "_linefills", []);
  }
  /**
   * Helper method to unwrap Series values
   */
   ...
   */
  get all() {
    return this._linefills.filter((l) => !l._deleted);
  }
  /**
   * Creates a new linefill object.
   */
  new(line1, line2, color) {
...
const _PolylineObject = class _PolylineObject {
  constructor(context, options = {}) {
    this.context = context;
    __publicField$8(this, "_id");
    __publicField$8(this, "_points");
    __publicField$8(this, "_curved");
    __publicField$8(this, "_closed");
    __publicField$8(this, "_xloc");
    __publicField$8(this, "_line_color");
    __publicField$8(this, "_fill_color");
    __publicField$8(this, "_line_style");
    __publicField$8(this, "_line_width");
    this._id = _PolylineObject._nextId++;
...
__publicField$8(_PolylineObject, "_nextId", 1);
let PolylineObject = _PolylineObject;
...
class Polyline {
  constructor(context) {
    this.context = context;
    __publicField$7(this, "_polylines", []);
  }
  /**
   * Helper method to unwrap Series values
   */
   ...
   */
  get all() {
    return this._polylines.filter((p) => !p._deleted);
  }
  /**
   * Creates a new polyline object.
   */
  new(points, curved, closed, xloc, line_color, fill_color, line_style, line_width) {
    const polyline = new PolylineObject(this.context, {
      points,
      curved: curved !== void 0 ? Series.from(curved).get(0) : void 0,
      closed: closed !== void 0 ? Series.from(closed).get(0) : void 0,
      xloc: xloc ? Series.from(xloc).get(0) : void 0,
      line_color: line_color ? Series.from(line_color).get(0) : void 0,
      fill_color: fill_color ? Series.from(fill_color).get(0) : void 0,
      line_style: line_style ? Series.from(line_style).get(0) : void 0,
      line_width: line_width ? Series.from(line_width).get(0) : void 0
    });
...
const _TableObject = class _TableObject {
  constructor(context, options = {}) {
    this.context = context;
    __publicField$6(this, "_id");
    __publicField$6(this, "_position");
    __publicField$6(this, "_columns");
    __publicField$6(this, "_rows");
    __publicField$6(this, "_bgcolor");
    __publicField$6(this, "_frame_color");
    __publicField$6(this, "_frame_width");
    __publicField$6(this, "_border_color");
    __publicField$6(this, "_border_width");
    __publicField$6(this, "_cells");
    this._id = _TableObject._nextId++;
  ...
  _getCellKey(column, row) {
    return `${column},${row}`;
  }
  /**
   * Sets the content of a cell.
   */
  cell(column, row, text = "", width = 0, height = 0, text_color = "#FFFFFF", text_halign = "center", text_valign = "center", text_size = "normal", bgcolor = "", tooltip = "", text_font_family = "default") {
  ...
  cell_set_text_color(column, row, color) {
    const key = this._getCellKey(
      Series.from(column).get(0),
      Series.from(row).get(0)
    );
  ...
  cell_set_text_halign(column, row, halign) {
    const key = this._getCellKey(
      Series.from(column).get(0),
      Series.from(row).get(0)
    );
  ...
  cell_set_text_valign(column, row, valign) {
    const key = this._getCellKey(
      Series.from(column).get(0),
      Series.from(row).get(0)
    );
  ...
  cell_set_text_size(column, row, size) {
    const key = this._getCellKey(
      Series.from(column).get(0),
      Series.from(row).get(0)
    );
  ...
  cell_set_text_font_family(column, row, family) {
    const key = this._getCellKey(
      Series.from(column).get(0),
      Series.from(row).get(0)
    );
  ...
  cell_set_bgcolor(column, row, color) {
    const key = this._getCellKey(
      Series.from(column).get(0),
      Series.from(row).get(0)
    );
  ...
  cell_set_width(column, row, width) {
    const key = this._getCellKey(
      Series.from(column).get(0),
      Series.from(row).get(0)
    );
  ...
  cell_set_height(column, row, height) {
    const key = this._getCellKey(
      Series.from(column).get(0),
      Series.from(row).get(0)
    );
  ...
  cell_set_tooltip(column, row, tooltip) {
    const key = this._getCellKey(
      Series.from(column).get(0),
      Series.from(row).get(0)
    );
   ...
   */
  merge_cells(start_column, start_row, end_column, end_row) {
  }
  /**
   * Clears the table.
   */
  clear(start_column = 0, start_row = 0, end_column, end_row) {
  ...
  toJSON() {
    ...
    this._cells.forEach((cell, key) => {
      ...
      cells.push({ column: col, row, ...cell });
    });
    return {
      id: this._id,
...
__publicField$6(_TableObject, "_nextId", 1);
let TableObject = _TableObject;
...
class Table {
   ...
   */
  new(position, columns, rows, bgcolor, frame_color, frame_width, border_color, border_width) {
    const table = new TableObject(this.context, {
      ...
      bgcolor: bgcolor ? Series.from(bgcolor).get(0) : void 0,
      frame_color: frame_color ? Series.from(frame_color).get(0) : void 0,
      frame_width: frame_width ? Series.from(frame_width).get(0) : void 0,
      border_color: border_color ? Series.from(border_color).get(0) : void 0,
      border_width: border_width ? Series.from(border_width).get(0) : void 0
    });
   ...
   * Sets the content of a cell.
   */
  cell(id, column, row, text, width, height, text_color, text_halign, text_valign, text_size, bgcolor, tooltip, text_font_family) {
    id?.cell(
      column,
      row,
      text,
  ...
  cell_set_text(id, column, row, text) {
    id?.cell_set_text(column, row, text);
  }
  cell_set_text_color(id, column, row, color) {
    id?.cell_set_text_color(column, row, color);
  }
  cell_set_text_halign(id, column, row, halign) {
    id?.cell_set_text_halign(column, row, halign);
  }
  cell_set_text_valign(id, column, row, valign) {
    id?.cell_set_text_valign(column, row, valign);
  }
  cell_set_text_size(id, column, row, size) {
    id?.cell_set_text_size(column, row, size);
  }
  cell_set_text_font_family(id, column, row, family) {
    id?.cell_set_text_font_family(column, row, family);
  }
  cell_set_bgcolor(id, column, row, color) {
    id?.cell_set_bgcolor(column, row, color);
  }
  cell_set_width(id, column, row, width) {
    id?.cell_set_width(column, row, width);
  }
  cell_set_height(id, column, row, height) {
    id?.cell_set_height(column, row, height);
  }
  cell_set_tooltip(id, column, row, tooltip) {
    id?.cell_set_tooltip(column, row, tooltip);
  }
  merge_cells(id, start_column, start_row, end_column, end_row) {
    id?.merge_cells(start_column, start_row, end_column, end_row);
  }
  clear(id, start_column, start_row, end_column, end_row) {
  ...
  set_frame_color(id, color) {
    id?.set_frame_color(color);
  }
  set_frame_width(id, width) {
...
const _Context = class _Context {
  constructor({
    ...
    __publicField$4(this, "indicator");
    __publicField$4(this, "cache", {});
    __publicField$4(this, "taState", {});
    // State for incremental TA calculations
    __publicField$4(this, "isSecondaryContext", false);
    // Flag to prevent infinite recursion in request.security
    __publicField$4(this, "NA", NaN);
    __publicField$4(this, "lang");
    // Combined namespace and core functions - the default way to access everything
    __publicField$4(this, "pine");
    __publicField$4(this, "idx", 0);
    __publicField$4(this, "params", {});
    __publicField$4(this, "const", {});
    __publicField$4(this, "var", {});
    __publicField$4(this, "let", {});
    __publicField$4(this, "result");
    __publicField$4(this, "plots", {});
    __publicField$4(this, "marketData");
    __publicField$4(this, "source");
    __publicField$4(this, "tickerId");
    __publicField$4(this, "timeframe", "");
    __publicField$4(this, "limit");
    __publicField$4(this, "sDate");
    __publicField$4(this, "eDate");
    __publicField$4(this, "fullContext");
    __publicField$4(this, "pineTSCode");
    __publicField$4(this, "inputs", {});
    //#region [Call Stack Management] ===========================
    __publicField$4(this, "_callStack", []);
    ...
    if (this.pine.dayofweek && typeof this.pine.dayofweek === "function") {
      this.pine.dayofweek.sunday = 1;
      this.pine.dayofweek.monday = 2;
      this.pine.dayofweek.tuesday = 3;
      this.pine.dayofweek.wednesday = 4;
      this.pine.dayofweek.thursday = 5;
      this.pine.dayofweek.friday = 6;
      this.pine.dayofweek.saturday = 7;
    }
...
__publicField$4(_Context, "_deprecationWarningsShown", /* @__PURE__ */ new Set());
...
class PineTS {
  constructor(source, tickerId, timeframe, limit, sDate, eDate) {
    ...
    __publicField$2(this, "open", []);
    __publicField$2(this, "high", []);
    __publicField$2(this, "low", []);
    __publicField$2(this, "close", []);
    __publicField$2(this, "volume", []);
    ...
    //#endregion
    //public fn: Function;
    __publicField$2(this, "_readyPromise", null);
    __publicField$2(this, "_ready", false);
    __publicField$2(this, "_debugSettings", {
      ln: false,
      debug: false
    });
...
class BinanceProvider {
  ...
  constructor() {
    ...
    __publicField$1(this, "activeApiUrl", null);
...
class MockProvider {
   ...
   */
  getDataFileName(tickerId, timeframe, sDate, eDate) {
    if (sDate && eDate) {
   ...
   */
  findDataFile(tickerId, timeframe, sDate, eDate) {
    ...
    const matchingFiles = files.filter((file) => pattern.test(file)).map((file) => {
   ...
   */
  filterData(data, sDate, eDate, limit) {
    let filtered = data;
    if (sDate || eDate) {
...
export { Context, Indicator, PineTS, Provider };
