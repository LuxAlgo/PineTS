/**
 * strategy.order() - Place an order
 * It allows you to place orders without needing to specify an entry ID.
 * Unlike strategy.entry(), orders placed with strategy.order() are not subject to pyramiding.
 *
 ...
 */
export declare function order(context: any): (id: string, direction: "long" | "short", qty?: number, limit?: number, stop?: number, oca_name?: string, oca_type?: string, comment?: string, alert_message?: string, disable_alert?: boolean) => void;
