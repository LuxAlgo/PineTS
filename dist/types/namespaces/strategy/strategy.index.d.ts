...
declare const actionMethods: {
    avg_losing_trade_percent: typeof avg_losing_trade_percent;
    avg_trade_percent: typeof avg_trade_percent;
    avg_winning_trade_percent: typeof avg_winning_trade_percent;
    cancel: typeof cancel;
    cancel_all: typeof cancel_all;
    close: typeof close;
    close_all: typeof close_all;
    entry: typeof entry;
    exit: typeof exit;
    grossloss_percent: typeof grossloss_percent;
    grossprofit_percent: typeof grossprofit_percent;
    max_drawdown_percent: typeof max_drawdown_percent;
    max_runup_percent: typeof max_runup_percent;
    netprofit_percent: typeof netprofit_percent;
    openprofit_percent: typeof openprofit_percent;
    order: typeof order;
    param: typeof param;
    strategy: typeof strategy;
};
declare const opentradesMethods: {
    opentrades_entry_bar_index: typeof opentrades_entry_bar_index;
    opentrades_entry_id: typeof opentrades_entry_id;
    opentrades_entry_price: typeof opentrades_entry_price;
    opentrades_entry_time: typeof opentrades_entry_time;
    opentrades_profit: typeof opentrades_profit;
    opentrades_size: typeof opentrades_size;
};
declare const closedtradesMethods: {
    closedtrades_commission: typeof closedtrades_commission;
    closedtrades_entry_bar_index: typeof closedtrades_entry_bar_index;
    closedtrades_entry_price: typeof closedtrades_entry_price;
    closedtrades_exit_bar_index: typeof closedtrades_exit_bar_index;
    closedtrades_exit_price: typeof closedtrades_exit_price;
    closedtrades_max_drawdown: typeof closedtrades_max_drawdown;
    closedtrades_max_runup: typeof closedtrades_max_runup;
    closedtrades_profit: typeof closedtrades_profit;
    closedtrades_size: typeof closedtrades_size;
};
...
export declare class PineStrategy {
    private context;
